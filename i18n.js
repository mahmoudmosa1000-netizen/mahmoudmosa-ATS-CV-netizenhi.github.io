...
const TRANSLATIONS = {
  ...
  en: {
    ...
    folioWhyTitle:       '✨ Why QR codes on your CV?',
    ...
    folioBenefit3Desc:   'Portfolio, GitHub, reference project, LinkedIn — every link gets its own QR code.',
    folioBenefit4Title:  'Professional impression',
    folioBenefit4Desc:   'Shows digital competence and makes your application stand out.',
    ...
    folioStep3:          'Choose a <strong>link text</strong> — the words that appear clickable on your CV (e.g. "My Portfolio", "GitHub Projects").',
    folioStep4:          'Enable <strong>Show as link</strong> and/or <strong>Embed QR code</strong> — both can be combined.',
    folioStep5:          'All links & QR codes automatically appear in the <strong>left sidebar</strong> of your CV.',
    folioStep6:          'Add as <strong>many links</strong> as you like — e.g. portfolio, GitHub, reference site, YouTube demo.',
    btnAddFolioLink:     '+ Add link & QR code',
    labelFolioURL:       'URL',
    placeholderFolioURL: 'https://behance.net/...',
    labelFolioLinkText:  'Link text on CV',
    placeholderFolioLinkText: 'e.g. My Portfolio',
    folioLinkTextHint:   'This text appears clickable on your CV (e.g. "GitHub Projects", "My Designs").',
    labelFolioDisplayAs: 'Display as',
    folioOptionLink:     '🔗 Clickable link',
    folioOptionQR:       '🔲 Embed QR code',
    folioQRPreviewLabel: 'QR code preview',
    btnRegenQR:          '🔄 Regenerate',
    btnDownloadFolioQR:  '⬇ PNG',
    labelFolioQRPos:     'QR code position on CV',
    folioPosLeft:        '⬅ Sidebar',
    folioPosOverlay:     '📌 Place freely on CV',
    ...
    labelSummary:        'Profile Summary',
    placeholderSummary:  'Describe yourself in 3–5 sentences ...',
    websiteTip:          '💡 Tip: Write <strong>%%WEBSITE%%</strong> in the text to insert your link there.',
    sectionGoal:         'Objective',
    labelGoal:           'Career Objective',
    ...
    btnAddEducation:     '+ Add education entry',
    labelDegree:         'Degree / Field of Study',
    placeholderDegree:   'e.g. High School Diploma',
    labelSchool:         'School / University',
    placeholderSchool:   'e.g. Technical College',
    ...
    placeholderLang:     'German',
    labelLangLevel:      'Level',
    optNative:           'Native speaker',
    ...
    labelSectionSide:    'Position on CV',
    optSideRight:        '➡ Right',
    ...
    // Driving licence
    sectionLicense:         'Driving Licence',
    labelLicenseClasses:    'Licence Classes',
    labelLicenseNote:       'Additional Info (optional)',
    placeholderLicenseNote: 'e.g. Own vehicle available',
    cvLicense:              'Driving Licence',
    ...
    // Page 2 tab
    sectionPage2:        'Page 2 — Additional Content',
    page2Info:           'Add a second page here — e.g. projects, certificates or a cover letter.',
    ...
    placeholderFreetext: 'e.g. I look forward to your interview invitation...',
    entryP2:             'Entry',
    ...
    toastPDFError:       '❌ Error while creating',
    ...
    // Tips & hints
    refTip:              'Add contacts who can recommend you. These appear as cards on your CV.',
    sectionOrderTip:     'Drag the sections to change their order on your CV.',
    tipsLabel:           'Tips:',
    qrTipEcl:            'Higher ECL level → more robust scanning, even if printing isn\'t perfect.',
    qrTipLogo:           'Use H-level if you want to display a logo in the centre (coming soon).',
    qrTipTest:           'Always test the QR code with your phone before printing.',
    importHint:          'JSON Resume Standard (jsonresume.org)',
    exportHint:          'Saves all your data as a JSON file — ideal as a backup or to transfer to another device.',
    ...
    // Labels
    labelPosInCV:        'Position on CV',
    labelCustomColor:    'Custom colour',
    labelRightBg:        'Right side background colour',
    labelQRShow:         'Show QR code on CV',
    ...
    labelQRLabelPos:     'Caption position',
    labelQRLabelText:    'Caption text',
    ...
    optLabelNone:        'No caption',
    optLabelBelow:       'Below the QR code',
    optLabelAbove:       'Above the QR code',
    optFrameNone:        'None',
    optFrameSquare:      'Square',
    optFrameRound:       'Rounded',
    optFrameShadow:      'Shadow',
    optFrameBadge:       'Badge',
    optFrameColor:       'Colour',
    ...
    qrDragTip:           '💡 You can also drag the QR code directly in the preview area with your mouse.',
    ...
    // Card placeholders
    placeholderRefName:    'e.g. Maria Smith',
    placeholderRefPos:     'e.g. Department Head',
    placeholderRefCompany: 'e.g. Company Ltd',
    placeholderRefEmail:   'e.g. m@company.com',
